...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dH, grads['W2'], grads['b2'] = affine_backward(dS, affine_cache)
        grads['W2'] += self.reg * self.params['W2']
        _, grads['W1'], grads['b1'] = affine_relu_backward(dH, affine_relu_cache)
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3 * 32 * 32, num_classes=10,
        ...
        ############################################################################
        total_layer_dims = [input_dim] + hidden_dims + [num_classes]
        # http://stackoverflow.com/questions/21303224/iterate-over-all-pairs-of-consecutive-items-from-a-given-list
        idx = 1
